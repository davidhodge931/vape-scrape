...
folder_path <- fs::path("vapo", "data", timestamp)
...
browseURL("https://www.vapo.co.nz/sitemap_products_1.xml?from=4013452164&to=7614385815691")

#3. scrape the data and then clean into an output dataset
scripts <- fs::dir_ls(fs::path("vapo", "R")) |>
